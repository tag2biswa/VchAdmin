...
<head>
    ...
    <script type="text/javascript" src="script/deleteRoom.js"></script>
                ...
                <div class="pull-right main_content">
                    <div class="row">
                        <div class="col-md-12 form-group">
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#add-new-item">Add New Room</button>
                        </div>
                    </div>
                    <!-- Menu Listing -->
                            ...
                            <?php
                              ...
                              if(mysqli_num_rows($res) > 0) {
                                ...
                                while($row = mysqli_fetch_object($res)) {
                                  $i++;
                                  $type_number = $row->room_type_num;
                                  $sql2 = "select * from `room_type` where `room_type_num`= $type_number";
                                  $res2 = mysqli_query($con, $sql2);
                                  if(mysqli_num_rows($res2) > 0) {
                                    $row2 = mysqli_fetch_object($res2);
                                    $room_tpe_name = $row2->room_type_name;
                                  }
                                  ?>
                                  <tr>
                                  <td><?php echo $i; ?></td>
                                  <td><?php echo $row->room_num; ?></td>
                                  <td><?php echo $room_tpe_name; ?></td>
                                  ...
                                  <a class="btn delete_room" data-room-id="<?php echo $row->room_num; ?>" href="javascript:void(0)">
