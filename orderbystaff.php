	...
	<div class="V_Hotel">
		...
		<div class="row section">
			...
			<div class="pull-right main_content">
				<!-- <div class="search">
					<input class="form-control" id="myInput" type="text" placeholder="Enter staff id">
				</div> -->
				<div class="input-group stylish-input-group search">
                    <input type="text" class="form-control"  placeholder="Enter staff id" id="myInput">
				...
				<br>
				<!-- Menu Listing -->
				<table class="table table-striped admin-table" id="myTable">
					<thead>
						<tr>
							<!-- <th>Sl No.</th> -->
							<th>Order Id</th>
						...
						if(mysqli_num_rows($res) > 0) {
							...
							while($row = mysqli_fetch_object($res)) {
								...
								<tr>
									...
									<td><?php echo $row->last_modification_time; ?></td>
