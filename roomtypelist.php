...
<head>
  ...
  <script type="text/javascript" src="script/deleteRoomType.js"></script>
  <script type="text/javascript">
    $(document).ready(function() {
      $('#room_type_save').click(function() {
        $('#upload_form').submit();
      });
      $('#upload_form').on('submit', function(e) {
        e.preventDefault();
        $.ajax({
          url: "room_type_upload.php",
          method: "POST",
...
<div class="pull-right main_content">
  ...
  <div class="row">
    <div class="col-md-12 form-group">
      <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#add-new-item">Add New Room Type</button>
    </div>
  </div>
        ...
        while($row = mysqli_fetch_object($res)) {
          ...
          <tr>
            ...
            <td>
              ...
              <a class="btn delete_room_type" data-room-type-id="<?php echo $row->room_type_num; ?>" href="javascript:void(0)">
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
                <label>Name</label>
                <input type="text" class="form-control" placeholder="Room Type Name" name="roomtype_name" required="required">
              </div>
            </div>
          </div>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-info" name="room_type_save" id="room_type_save"> Save </button>
